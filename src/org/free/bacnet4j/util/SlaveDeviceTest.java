...
public class SlaveDeviceTest {
    public static void main(String[] args) throws Exception {
        ...
        String broadcastIp = "192.168.163.255";
        if (args.length >= 2) {
            broadcastIp = args[1];
        }
        LocalDevice localDevice = new LocalDevice(deviceid, new Transport(new IpNetwork(broadcastIp, 47808)));
        ...
        av0.setProperty(PropertyIdentifier.covIncrement, new Real(1));
